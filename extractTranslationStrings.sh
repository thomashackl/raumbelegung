...
do
    ...
    > "$LOCALE_RELATIVE_PATH/$language/LC_MESSAGES/roomplanplugin.UTF-8.po"
    find $TRANSLATIONFILES_RELATIVE_PATHS \( -iname "*.php" \) | xargs xgettext --from-code=ISO-8859-1 -j -n --language=PHP -o "$LOCALE_RELATIVE_PATH/$language/LC_MESSAGES/roomplanplugin.UTF-8.po"
    msgconv --to-code=iso-8859-1 "$LOCALE_RELATIVE_PATH/$language/LC_MESSAGES/roomplanplugin.UTF-8.po" -o "$LOCALE_RELATIVE_PATH/$language/LC_MESSAGES/roomplanplugin.po"
    ...
    test -f "$LOCALE_RELATIVE_PATH/$language/LC_MESSAGES/roomplanplugin.UTF-8.po" && rm "$LOCALE_RELATIVE_PATH/$language/LC_MESSAGES/roomplanplugin.UTF-8.po"
done
